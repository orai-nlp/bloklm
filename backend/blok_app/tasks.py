...
def generate_summary_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "summary", res_content, collection_id)
...
def generate_faq_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "FAQ", res_content, collection_id)
    db.update_note(note_id, title, res_content)
...
def generate_glossary_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "glossary", res_content, collection_id)
    db.update_note(note_id, title, res_content)
...
def generate_outline_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "outline", res_content, collection_id)
    db.update_note(note_id, title, res_content)
...
def generate_chronogram_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "timeline", res_content, collection_id)
    db.update_note(note_id, title, res_content)
...
def generate_mind_map_task(llm, db, note_id, collection_id, file_ids, custom_conf):
    ...
    title = resgen.generate_note_title(llm, db, "mindmap", res_content, collection_id)
    db.update_note(note_id, title, res_content)
